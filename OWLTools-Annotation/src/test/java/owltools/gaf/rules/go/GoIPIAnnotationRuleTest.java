...
/**
 * Tests for {@link GoIPIAnnotationRule}.
 */
public class GoIPIAnnotationRuleTest extends AbstractEcoRuleTestHelper {

	@Test
	public void test() throws Exception {
		GafDocument gafdoc = loadGaf("test_gene_association_mgi.gaf");
		AnnotationRule rule = new GoIPIAnnotationRule(eco);
